...
app.add_url_rule('/users/rank', view_func=views.ranker, methods=["GET", "POST"])
app.add_url_rule('/redeem', view_func=views.redeem, methods=["GET", "POST"])
app.add_url_rule('/create/code', view_func=views.create_code, methods=["GET", "POST"])
